...
class AR2_Twitter_Feed_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		// echo $before_widget;
		// echo $before_title . $title . '<a href="http://www.twitter.com/bancaynegocios"><img src="http://dev.geekies.co/bancaynegocios/wp-content/uploads/2013/05/twitter.png" alt=""></a>' . $after_title;
