...
define('DB_USER', 'icordoba');//'C291728_byn');//define('DB_USER', 'root');

/** MySQL database password */
define('DB_PASSWORD', 'Es0KLQPy');//'Banca2013');//define('DB_PASSWORD', '435389');

/** MySQL hostname */
define('DB_HOST', 'localhost');//'mysql1009.ixwebhosting.com');
